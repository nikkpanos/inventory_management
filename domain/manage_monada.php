                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 auto-width">
                            <h3 class="mb-4">ΟΛΕΣ ΟΙ ΜΟΝΑΔΕΣ</h3>
                                    ...
                                    <?php
                                        ...
                                        try{
                                            ...
                                            if($_SERVER['REQUEST_METHOD'] == 'GET'){
                                                ...
                                                $stmt = mysqli_prepare($dbcon, 'SELECT * from monada order by monada_name');
                                                
                                                mysqli_stmt_execute($stmt);
                                                mysqli_stmt_store_result($stmt);
                                                mysqli_stmt_bind_result($stmt, $id_monada, $monada_name);
                                                $aa = 1;
                                                while (mysqli_stmt_fetch($stmt)){
                                                    ...
                                                    print "<td>\n<button type='button' class='btn btn-primary' data-bs-toggle='modal' 
                                                            data-bs-target='#change_monada$id_monada'>Επεξεργασία</button></td>";
                                        ?>
                                            <!-- Toggle Form Start (ΓΙΑ ΤΟ BUTTON ΤΡΟΠΟΠΟΙΗΣΗ)-->
                                            <div class="modal fade" id="change_monada<?php print $id_monada; ?>" tabindex="-1" aria-labelledby="change_monada<?php print $id_monada; ?>" aria-hidden="true">
                                                <div class="modal-dialog position-absolute top-50 start-50 translate-middle">
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Αλλαγή ονόματος μονάδας</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form method="post" action="noview_monada.php">
                                                    <div class="modal-body"> 
                                                        <div class="mb-3">
                                                            <label for="monada_name" class="col-form-label">Εισάγετε το νέο όνομα:</label>
                                                            <input type="text" class="form-control" name="monada_name">
                            ...
                            print "<button type='button' class='btn btn-primary' data-bs-toggle='modal' 
                                    data-bs-target='#create_monada'>Προσθήκη Μονάδας</button>\n"; 
                            ?>
                            <!-- Toggle Form Start (ΓΙΑ ΤΟ BUTTON ΔΗΜΙΟΥΡΓΙΑ)-->
                            <div class="modal fade" id="create_monada" tabindex="-1" aria-labelledby="create_monada" aria-hidden="true">
                                <div class="modal-dialog position-absolute top-50 start-50 translate-middle">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Καταχώριση νέας μονάδας</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form method="post" action="noview_monada.php">
                                    <div class="modal-body"> 
                                        <div class="mb-3">
                                            <label for="monada_name" class="col-form-label">Εισάγετε όνομα:</label>
                                            <input type="text" class="form-control" name="monada_name">
