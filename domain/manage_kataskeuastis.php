                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 auto-width">
                            <h3 class="mb-4">ΟΛΟΙ ΟΙ ΚΑΤΑΣΚΕΥΑΣΤΕΣ</h3>
                            ...
                            <!-- <div id="search">
                                ...
                                <thead style="position: sticky; top:0">
                                    <tr class="bg-light">
                                        <th scope="col">#</th>
                                        <th scope="col">ID ΚΑΤΑΣΚΕΥΑΣΤΗ</th>
                                ...
                                <tbody>
                                    ...
                                    try{
                                        ...
                                        if($_SERVER['REQUEST_METHOD'] == 'GET'){
                                            ...
                                            $stmt = mysqli_prepare($dbcon, 'SELECT * from kataskeuastis order by kataskeuastis_name');
                                            
                                            mysqli_stmt_execute($stmt);
                                            mysqli_stmt_store_result($stmt);
                                            mysqli_stmt_bind_result($stmt, $id_kataskeuastis, $kataskeuastis_name);
                                            $aa = 1;
                                            while (mysqli_stmt_fetch($stmt)){
                                                ...
                                                print "<td>\n<button type='button' class='btn btn-primary' data-bs-toggle='modal' 
                                                        data-bs-target='#change_kataskeuastis$id_kataskeuastis'>Επεξεργασία</button></td>";
                                    ?>
                                        <!-- Toggle Form Start (ΓΙΑ ΤΟ BUTTON ΤΡΟΠΟΠΟΙΗΣΗ)-->
                                        <div class="modal fade" id="change_kataskeuastis<?php print $id_kataskeuastis; ?>" tabindex="-1" aria-labelledby="change_kataskeuastis<?php print $id_kataskeuastis; ?>" aria-hidden="true">
                                            <div class="modal-dialog position-absolute top-50 start-50 translate-middle">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Αλλαγή ονόματος κατασκευαστή</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="post" action="noview_kataskeuastis.php">
                                                <div class="modal-body"> 
                                                    <div class="mb-3">
                                                        <label for="kataskeuastis_name" class="col-form-label">Εισάγετε το νέο όνομα:</label>
                                                        <input type="text" class="form-control" name="kataskeuastis_name">
                                                        <input type="hidden"name="id_kataskeuastis" value="<?php print $id_kataskeuastis; ?>">
                            ...
                            print "<button type='button' class='btn btn-primary' data-bs-toggle='modal' 
                                    data-bs-target='#create_kataskeuastis'>Προσθήκη Κατασκευαστή</button>\n"; 
                            ?>
                            <!-- Toggle Form Start (ΓΙΑ ΤΟ BUTTON ΔΗΜΙΟΥΡΓΙΑ)-->
                            <div class="modal fade" id="create_kataskeuastis" tabindex="-1" aria-labelledby="create_kataskeuastis" aria-hidden="true">
                                <div class="modal-dialog position-absolute top-50 start-50 translate-middle">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Καταχώριση νέου κατασκευαστή</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form method="post" action="noview_kataskeuastis.php">
                                    <div class="modal-body"> 
                                        <div class="mb-3">
                                            <label for="kataskeuastis_name" class="col-form-label">Εισάγετε όνομα:</label>
                                            <input type="text" class="form-control" name="kataskeuastis_name">
